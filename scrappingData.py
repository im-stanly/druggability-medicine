...
def parse_args() -> argparse.Namespace:
	...
	parser.add_argument("--output-dir", default="data/01_raw/protein_ligand_raw")
	parser.add_argument("--output-json", default="data/01_raw/protein_ligand_raw/rscb_hits.json")
